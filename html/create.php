        ...
        <form action="../assets/php/create_recipe.php" class="create form" method="post" enctype="multipart/form-data">
            ...
            <div class="info-recipe">
                <label for="recipe-title" class="title">
                    ...
                    <input type="text" name="recipe-title" placeholder="Título">
                </label>
            </div>
            ...
            <label for="portions">
                ...
                <label for="preparation-time">
                    ...
                    <input placeholder="xx minutos" type="text" name="preparation-time">
                </label>
            ...
            <div class="info-recipe">
                <div class="ingredients">
                    <label for="quantity">
                        <h3>Quantidade</h3>
                        <input type="text" name="quantity" placeholder="Insira a quantidade">
                    </label>
